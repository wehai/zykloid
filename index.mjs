...
{ try{
 ...
 if(zug == 4){  
   ...
   if(!sessionId){
      console.log("hey no id")
try{
   console.log("hey no id")
updatedContent= await gallerydb.findAsync({'doneSessionsdb.posted':"true"})
}catch(error){
   console.warn(error)
}
}else{
 
   updatedContent= await gallerydb.findOneAsync({'doneSessionsdb._id':sessionId})
}
...
try{
    ...
    console.log("session:"+fullsessionzug2._id+" zug2 is full")
} catch(error){
     console.warn(error) 
  }
 }
...
try{
    ...
    console.log("session:"+fullsessionzug3._id+" zug3 is full")
} catch(error){
     console.warn(error) 
  }
 }
...
try{
    await sessionsdb.updateAsync({ _id: fullsessionzug4._id },{ $set: { 'zug4.full': "true" } }, { multi: true})
     console.log("session:"+fullsessionzug4._id+" zug4 is full")
} catch(error){
     console.warn(error) 
  }
 }
...
try{
    ...
    console.log("session:"+fullsessionzug5._id+" zug5 is full")
} catch(error){
     console.warn(error) 
  }
 }
...
try{
    ...
    console.log("session:"+fullsessionzug6._id+" zug6 is full")
} catch(error){
     console.warn(error) 
  }
 }
...
let doneSessionsdb
try{
   doneSessionsdb= await sessionsdb.findOneAsync({$and: [{'done':"true"},{'posted':"false"}]})
  }catch(error)
  {console.warn(error)}

if(!doneSessionsdb){}else{
   await gallerydb.insertAsync({doneSessionsdb})
...
doneSession = await gallerydb.findOneAsync({$and: [{"doneSessionsdb.done":"true"},{"doneSessionsdb.posted":"false"}]})
if(!doneSession){}else{
...
const z2 = doneSession.doneSessionsdb.zug2.submissions
const z1 = doneSession.doneSessionsdb.zug1.submissions
const z3 = doneSession.doneSessionsdb.zug3.submissions
const z4 = doneSession.doneSessionsdb.zug4.submissions
const z5 = doneSession.doneSessionsdb.zug5.submissions
const z6 = doneSession.doneSessionsdb.zug6.submissions
console.log(z1 + z2)
const aa = z1[0]; const bb = z2[0];  const cc = z3[0];  const dd = z4[0];  const ee = z5[0]; const ff = z6[0]; 
const abfolge1 =[aa,bb,cc,dd,ee,ff]
const ab = z1[1]; const bc = z2[1];  const cd = z3[1];  const de = z4[1];  const ef = z5[1]; const fa = z6[1]; 
const abfolge2 =[ab,bc,cd,de,ef,fa]
const ac = z1[2]; const bd = z2[2];  const ce = z3[2];  const df = z4[2];  const ea = z5[2]; const fb = z6[2]; 
const abfolge3 =[ac,bd,ce,df,ea,fb]
const ad = z1[3]; const be = z2[3];  const cf = z3[3];  const da = z4[3];  const eb = z5[3]; const fc = z6[3]; 
const abfolge4 =[ad,be,cf,da,eb,fc]
const ae = z1[4]; const bf = z2[4];  const ca = z3[4];  const db = z4[4];  const ec = z5[4]; const fd = z6[4]; 
const abfolge5 =[ae,bf,ca,db,ec,fd]
const af = z1[5]; const ba = z2[5];  const cb = z3[5];  const dc = z4[5];  const ed = z5[5]; const fe = z6[5]; 
...
let scont;
await gallerydb.updateAsync({_id: doneSession._id},{$set: {'doneSessionsdb.zug1': [] }})
await gallerydb.updateAsync({_id: doneSession._id},{$set: {'doneSessionsdb.zug2': [] }})
await gallerydb.updateAsync({_id: doneSession._id},{$set: {'doneSessionsdb.zug3': [] }})
await gallerydb.updateAsync({_id: doneSession._id},{$set: {'doneSessionsdb.zug4': [] }})
await gallerydb.updateAsync({_id: doneSession._id},{$set: {'doneSessionsdb.zug5': [] }})
await gallerydb.updateAsync({_id: doneSession._id},{$set: {'doneSessionsdb.zug6': [] }})
...
scont = {img: cimg}}
console.log(scont)
await gallerydb.updateAsync({_id: doneSession._id},{$push: {'doneSessionsdb.zug1': scont }})
 })
 ...
 abfolge2.forEach(async function(element) {
   ...
   scont = {img: cimg}}
   console.log(scont)
   await gallerydb.updateAsync({_id: doneSession._id},{$push: {'doneSessionsdb.zug2': scont }})
    })
...
scont = {img: cimg}}
console.log(scont)
await gallerydb.updateAsync({_id: doneSession._id},{$push: {'doneSessionsdb.zug3': scont }})
 })
...
scont = {img: cimg}}
console.log(scont)
await gallerydb.updateAsync({_id: doneSession._id},{$push: {'doneSessionsdb.zug4': scont }})
 })
...
scont = {img: cimg}}
console.log(scont)
await gallerydb.updateAsync({_id: doneSession._id},{$push: {'doneSessionsdb.zug5': scont }})
 })
...
scont = {img: cimg}}
console.log(scont)
await gallerydb.updateAsync({_id: doneSession._id},{$push: {'doneSessionsdb.zug6': scont }})
 })
let postedSession
 try{
 postedSession = await gallerydb.findOneAsync({$and: [{'doneSessionsdb.posted':"false"},{$not: {'doneSessionsdb.zug6':[]}}]})
}catch(error){ console.warn(error)}
try{
await gallerydb.updateAsync({_id: postedSession._id},{$set: {'doneSessionsdb.posted':"true"}})
}catch(error){console.warn(error)}
//})
}
